...
SCRIPT_VERSION = "2026-08-19-v4-emission-override-low-light"
...
def save_image_pixels_rgba(path, rgba):
    ...
    img.pixels = np.clip(rgba, 0.0, 1.0).reshape(-1).tolist()
...
def render_asset(model_path, output_root, args, asset_name):
    ...
    center, coarse_scale, coarse_fill = solve_uniform_scale(verts_world, c2ws, args.fov, args.fill)
